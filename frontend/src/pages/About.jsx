...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Ritik Tomar (@ritiktomar)</h3>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="https://my-portfolio-olive-five-lf6qw1462a.vercel.app/" target="_blank" rel="noreferrer" style={socialBtnStyle}>🌐 Website</a>
        ...
        <a href="https://www.linkedin.com/in/ritik-tomar-547987200/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
        <a href="https://x.com/ritiktomar10x" target="_blank" rel="noreferrer" style={socialBtnStyle}>✖️ X (Twitter)</a>
